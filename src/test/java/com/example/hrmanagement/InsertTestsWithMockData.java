...
public class InsertTestsWithMockData {
    ...
    void addingWorkers(){
        List<User> users = Arrays.asList(
                new User("Joshua", "Kimmich", "username4", companyRepository.getById(1L),"password4","emailN4@gmail.com",  Collections.singleton(roleRepository.getByRole(RoleName.WORKER)), true, true, true, true, "this is the token1"),
    ...
    void addingWork(){
        List<WorkDto> works = Arrays.asList(
                ...
                new WorkDto("work7","you should be carefully", 1L, userRepository.getByUsername("username2").getId())
        );
